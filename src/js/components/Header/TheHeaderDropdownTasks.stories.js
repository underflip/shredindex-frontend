...
export default { title: 'TheHeaderDropdownTasks' };
const itemsCount = 5;
export const TheHeaderDropdownTasks = () => (
  ...
  >
    <CDropdownToggle className="c-header-nav-link" caret={false}>
      <CIcon content={cilList} name="cil-list"/>
    ...
    <CDropdownMenu placement="bottom-end" className="pt-0">
      ...
      <CDropdownItem className="text-center border-top"><strong>View all
        tasks</strong></CDropdownItem>
    </CDropdownMenu>
  </CDropdown>
);
