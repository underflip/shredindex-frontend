...
import { cilEnvelopeOpen } from '@coreui/icons/js/free/cil-envelope-open';

export default { title: 'TheHeaderDropdownMssg' };
const itemsCount = 4;
export const TheHeaderDropdownMssg = () => (
  ...
  >
    <CDropdownToggle className="c-header-nav-link" caret={false}>
      <CIcon name="cil-envelope-open" content={cilEnvelopeOpen}/><CBadge shape="pill" color="info">{itemsCount}</CBadge>
    </CDropdownToggle>
