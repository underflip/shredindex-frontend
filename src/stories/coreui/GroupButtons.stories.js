    ...
    <CCol xs={12}>
      <CCard className="mb-4">
        ...
        <CCardBody>
          ...
          <CButtonGroup className="mb-2" size="lg" role="group" aria-label="Large button group">
          ...
          <br />
          <CButtonGroup className="mb-2" role="group" aria-label="Default button group">
            <CButton color="dark" variant="outline">
              Left
            </CButton>
            <CButton color="dark" variant="outline">
          ...
          <br />
          <CButtonGroup className="mb-2" size="sm" role="group" aria-label="Small button group">
            <CButton color="dark" variant="outline">
              Left
            </CButton>
            <CButton color="dark" variant="outline">
    ...
    <CCol xs={12}>
      <CCard className="mb-4">
        ...
        <CCardBody>
          ...
          <CButtonGroup className="me-4" vertical role="group" aria-label="Vertical button group">
