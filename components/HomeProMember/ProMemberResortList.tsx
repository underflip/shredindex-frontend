...
import WatchThisSpace from '../../images/resort-card-watch-this-space.svg';
...
interface ProMemberResortListProps {
  title: string;
}

const ProMemberResortList: React.FC<ProMemberResortListProps> = ({ title }) => {
